    ...
    <div className="space-y-6">
      ...
      <div className="bg-zinc-900/60 border border-zinc-800/80 rounded-xl p-6">
        ...
        <input
          ...
          className="w-full px-6 py-4 text-3xl font-bold text-zinc-100 bg-zinc-950 border-2 border-zinc-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition placeholder:text-zinc-600 tabular-nums"
        />
      </div>
      ...
      {tiers.profit.length > 0 && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-zinc-900/60 border border-zinc-800/80 rounded-xl overflow-hidden">
            <div className="bg-green-950/20 border-b border-green-900/30 px-6 py-4">
            ...
            <div className="divide-y divide-zinc-800/50">
              {tiers.profit.map((tier) => (
                <div
                  key={tier.percentage}
                  className="px-6 py-3 flex items-center justify-between hover:bg-green-950/10 transition"
                >
          ...
          <div className="bg-zinc-900/60 border border-zinc-800/80 rounded-xl overflow-hidden">
            ...
            <div className="divide-y divide-zinc-800/50">
              {tiers.loss.map((tier) => (
                <div
                  key={tier.percentage}
                  className="px-6 py-3 flex items-center justify-between hover:bg-red-950/10 transition"
                >
